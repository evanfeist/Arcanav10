...
(function(){
  ...
  // Construct validation (includes your Stage-2/Stage-2.5 rules)
  ...
  function attemptConstructFromSelection(){
    ...
    // Joker cost required (non-JOKER_ONLY)
    if(res.kind!=='JOKER_ONLY' && res.jokersUsed>0){
      ...
      return null; // wait for drawer confirmation
    }
  ...
  jokerConfirm.addEventListener('click', ()=>{
    ...
    if(JSEL.size !== G.pendingConstruct.requiredN){ return; } // exact
